...
export function LoadingState({
  ...
  const defaultLabel = surfer ? "Subway surfing" : "Đang soạn câu trả lời...";
  const resolvedLabel = label ?? customLabel ?? defaultLabel;
  ...
  if (surfer) {
    return (
      <div role="status" aria-live="polite" className="flex w-fit flex-col items-start select-none py-1">
  ...
  return (
    <div role="status" aria-live="polite" className="flex w-fit items-center gap-2.5 select-none py-1">
...
export { LoadingState as AiThinkingState };
