...
const directPhraseMap = {
  ...
  "Đang xem khóa học cho lộ trình": "Showing courses for",
  "Đổi lộ trình": "Change Roadmap",
  ...
  "Nền tảng học tiếng Anh trực tuyến thế hệ mới tích hợp Trợ lý AI cá nhân hóa, phương pháp ghi nhớ phản xạ chủ động.": "Next-generation online English learning platform with personalized AI Tutor & active reflex retention.",
  "Khám phá": "Explore",
  ...
  "Beginner (Bắt đầu)": "Beginner (Starter)",
  "Elementary (Sơ cấp)": "Elementary",
  "Intermediate (Trung cấp)": "Intermediate",
  "Advanced (Nâng cao)": "Advanced",
  "Sắp xếp:": "Sort by:",
  "Mới nhất": "Newest",
  "Học viên đông nhất": "Most Popular",
  "Đánh giá cao nhất": "Top Rated",
  "Không tìm thấy kết quả phù hợp": "No matching courses found",
  "Thử thay đổi từ khóa tìm kiếm hoặc đặt lại bộ lọc của bạn để khám phá các khóa học khác.": "Try changing search keywords or resetting filters to discover other courses.",
  "Thiết lập lại bộ lọc": "Reset Filters",
  "Sắp mở:": "Opening soon:",
  "Học ngay": "Enroll Now",
  "Sắp mở": "Opening Soon",
  "Hệ thống E-Learning": "E-Learning System",
