...
def main():
    print("==================================================")
    print("🚀 BẮT ĐẦU CHẠY PIPELINE HUẤN LUYỆN RAG MODULAR")
    print("==================================================")
    ...
    docsearch = vector_store.upload_documents(chunks, embeddings_model)
    ...
    print("\n==================================================")
    print("🎉 PIPELINE HUẤN LUYỆN RAG ĐÃ HOÀN THÀNH XUẤT SẮC!")
    print("==================================================")
